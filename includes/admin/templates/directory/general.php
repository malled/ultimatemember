...
<div class="um-admin-metabox">
	...
	<div class="">
		...
		<p>
			<label class="um-admin-half"><?php _e('User Roles to Display','ultimatemember'); ?> <?php UM()->um_tooltip( 'If you do not want to show all members, select only user roles to appear in this directory' ); ?></label>
