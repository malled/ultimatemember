...
if ( ! class_exists( 'Builtin' ) ) {
    class Builtin {
        ...
        function unique_field_err( $key ){
            ...
            if ( ! UM()->validation()->safe_string( $key ) ) return __('Your meta key contains illegal characters. Please correct it.','ultimatemember');
            return 0;
        }
        ...
        function date_range_start_err( $date ) {
            ...
            if ( ! UM()->validation()->validate_date( $date ) ) return __('Please enter a valid start date in the date range','ultimatemember');
            return 0;
        }
        ...
        function date_range_end_err( $date, $start_date ) {
            ...
            if ( ! UM()->validation()->validate_date( $date ) ) return __('Please enter a valid end date in the date range','ultimatemember');
